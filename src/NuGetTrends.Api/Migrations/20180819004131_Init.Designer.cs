...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NuGet.Protocol.Catalog.PackageDependency", b =>
                {
            ...
            modelBuilder.Entity("NuGet.Protocol.Catalog.PackageDependencyGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("NuGet.Protocol.Catalog.PackageDetailsCatalogLeaf", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("NuGetTrends.Api.Cursor", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("NuGetTrends.Api.PackageRegistration", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("NuGet.Protocol.Catalog.PackageDependency", b =>
                {
                    b.HasOne("NuGet.Protocol.Catalog.PackageDependencyGroup")
            ...
            modelBuilder.Entity("NuGet.Protocol.Catalog.PackageDependencyGroup", b =>
                {
                    b.HasOne("NuGet.Protocol.Catalog.PackageDetailsCatalogLeaf")
